...
public class Player {
	...
	public Player(int player,String name){
		...
		Pikachu pikachu = new Pikachu(player,0, 0, this);
		character[0] = pikachu;
		Luffy luffy = new Luffy(player,0, 0, this);
		character[1] = luffy;
		Naruto naruto = new Naruto(player,0, 0, this);
		character[2] = naruto;
		Reborn reborn = new Reborn(player,0, 0, this);
		character[3] = reborn;
		Natsu natsu = new Natsu(player,0, 0, this);
		character[4] = natsu;
		Kurosaki kuro = new Kurosaki(player, 0, 0, this);
		character[5] = kuro;
	}
